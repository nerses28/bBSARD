...
from models.zeroshot_dense_models import Word2vecRetriever, FasttextRetriever, BERTRetriever, E5ChunkedRetriever, E5InstructChunkedRetriever, EmbRetriever, LaBSERetriever, JinaRetriever, GTERetriever, DPRRetriever
...
def main(args):
    ...
    if args.retriever == 'tfidf':
        ...
        if args.retriever == "e5-large-instruct":
            retriever = E5InstructChunkedRetriever(model_path_or_name=model_name, pooling_strategy='mean',
        ...
        retriever = E5ChunkedRetriever(model_path_or_name='castorini/mdpr-tied-pft-msmarco', pooling_strategy='mean',
                                       retrieval_corpus=articles)
        ...
        retriever = E5ChunkedRetriever(model_path_or_name='facebook/mcontriever-msmarco', pooling_strategy='mean',
                                       retrieval_corpus=articles)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--articles_embeddings_path",
                        type=str,
                        help="Path of the data file containing the law articles embeddings."
                        )
    parser.add_argument("--test_questions_embeddings_path",
                        type=str,
                        help="Path of the data file containing the test questions embeddings."
                        )
